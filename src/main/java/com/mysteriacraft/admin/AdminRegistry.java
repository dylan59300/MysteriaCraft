...
public final class AdminRegistry {
    ...
    public static final List<AdminModule> MODULES = List.of(
            new AdminModule("Economie", Material.GOLD_INGOT, "mysteriacraft.eco.admin",
                    "ecoreload", null, "eco", true),
            new AdminModule("Banque", Material.GOLD_BLOCK, "mysteriacraft.banque.admin",
                    "banque reload", null, null, true),
            new AdminModule("BattlePass", Material.NETHER_STAR, "mysteriacraft.battlepass.admin",
                    "battlepassadmin reload", "battlepassadmin editeur", "battlepass", false),
            new AdminModule("Quetes", Material.WRITABLE_BOOK, "mysteriacraft.quests.admin",
                    "questsadmin reload", null, "quests", false),
